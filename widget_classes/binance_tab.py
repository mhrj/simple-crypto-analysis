...
class BinanceTab(QWidget):
    ...
    def create_pie_chart(self):
        ...
        sentiment_data = sentiment_analysis.calculate_sentiment_distribution(coin_name="BNB")
    ...
    def create_summary_widget(self):
        ...
        price_data = CryptoAnalysis.fetch_crypto_price_data("BNB")
    ...
    def create_r_data_direct(self):
        # get data from backend
        data_dict_prices = CryptoAnalysis.fetch_crypto_prices_over_time("BNB")
        data_dict_smas = CryptoAnalysis.calculate_indicators("BNB")
    ...
    def create_daily_returns_table(self):
        # get data from backend
        data_BNB = CryptoAnalysis.calculate_daily_growth("BNB")
        data_index_zero = data_BNB["daily_growth"][0]
        data_index_one = data_BNB["daily_growth"][1]
        data_index_two = data_BNB["daily_growth"][2]
        """Create and return a table for daily returns."""
        table = self.create_table_widget(3, 2, ["Date", "Daily Growth (%)"], [
            [data_BNB["dates"][0], f"{data_index_zero}%"],
            [data_BNB["dates"][1], f"{data_index_one}%"],
            [data_BNB["dates"][2], f"{data_index_two}%"]
        ])
        return table
